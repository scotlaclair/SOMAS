...
create_label "somas-agent:pending-planner" "Planner agent is pending or in progress" "BFDADC" "$FORCE_MODE"
create_label "somas-agent:pending-specifier" "Specifier agent is pending or in progress" "BFDADC" "$FORCE_MODE"
create_label "somas-agent:pending-simulator" "Simulator agent is pending or in progress" "BFDADC" "$FORCE_MODE"
create_label "somas-agent:pending-architect" "Architect agent is pending or in progress" "BFDADC" "$FORCE_MODE"
create_label "somas-agent:pending-implementer" "Implementer agent is pending or in progress" "BFDADC" "$FORCE_MODE"
create_label "somas-agent:pending-tester" "Tester/validator agent is pending or in progress" "BFDADC" "$FORCE_MODE"
create_label "somas-agent:pending-deployer" "Deployer/staging agent is pending or in progress" "BFDADC" "$FORCE_MODE"
create_label "state:complete" "Pipeline execution complete - ready for review" "C5DEF5" "$FORCE_MODE"

# Stage Labels
echo -e "\n${YELLOW}[Stage Labels]${NC}"
create_label "somas:stage:intake" "Stage 1: INTAKE - Ingest issues and route requests" "E99695" "$FORCE_MODE"
create_label "somas:stage:specify" "Stage 2: SPECIFY - Convert intent into specifications" "E99695" "$FORCE_MODE"
create_label "somas:stage:plan" "Stage 3: PLAN - Design architecture and task graph" "E99695" "$FORCE_MODE"
create_label "somas:stage:decompose" "Stage 4: DECOMPOSE - Break into atomic tasks" "E99695" "$FORCE_MODE"
create_label "somas:stage:implement" "Stage 5: IMPLEMENT - Generate code and tests" "E99695" "$FORCE_MODE"
create_label "somas:stage:verify" "Stage 6: VERIFY - Run tests and self-heal" "E99695" "$FORCE_MODE"
create_label "somas:stage:integrate" "Stage 7: INTEGRATE - Merge and validate contracts" "E99695" "$FORCE_MODE"
create_label "somas:stage:harden" "Stage 8: HARDEN - Security scanning and audits" "E99695" "$FORCE_MODE"
create_label "somas:stage:release" "Stage 9: RELEASE - Package and deploy artifacts" "E99695" "$FORCE_MODE"
create_label "somas:stage:operate" "Stage 10: OPERATE - Health checks and monitoring" "E99695" "$FORCE_MODE"
create_label "somas:stage:analyze" "Stage 11: ANALYZE - Metrics and documentation" "E99695" "$FORCE_MODE"
...
create_label "somas-agent:planner-working" "Planner agent is currently working" "C5DEF5" "$FORCE_MODE"
create_label "somas-agent:specifier-working" "Specifier agent is currently working" "C5DEF5" "$FORCE_MODE"
create_label "somas-agent:simulator-working" "Simulator agent is currently working" "C5DEF5" "$FORCE_MODE"
create_label "somas-agent:architect-working" "Architect agent is currently working" "C5DEF5" "$FORCE_MODE"
create_label "somas-agent:implementer-working" "Implementer agent is currently working" "C5DEF5" "$FORCE_MODE"
create_label "somas-agent:tester-working" "Tester/validator agent is currently working" "C5DEF5" "$FORCE_MODE"
create_label "somas-agent:deployer-working" "Deployer agent is currently working" "C5DEF5" "$FORCE_MODE"
